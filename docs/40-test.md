...
### T-38: Player collision box width
- **Design Spec**: DS-38
- **Test File**: `src/game/width.test.js`
- **Description**: confirms the player collision box spans exactly one tile.
...
- **URS-017**: Player collision box matches one tile to fit narrow gaps.
