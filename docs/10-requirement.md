...
_Updated for v2.16.1: Trunk NPC keeps its sprite aspect ratio while moving from left to right without collisions._
...
- FR-058: The Trunk NPC renders using its native sprite aspect ratio.
